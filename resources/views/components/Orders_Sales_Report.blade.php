...
<div class="container">
    ...
    <a style="margin-left: 20px" href="#demo" class="btn  sidebar-bottom-btn  btn-lg btn-block " data-toggle="collapse">Sales Report</a>

    {{-- btn sidebar-bottom-btn mt-4 btn-lg btn-block --}}
