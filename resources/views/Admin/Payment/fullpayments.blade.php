                  ...
                  <div class="card">
                     <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                           <h6 style="color: seagreen" class="card-title">All full Payment: ₦ {{$amount}}</h6>
                        </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-action">
                                        ...
                                        <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="update payment"
                                            href="{{route('Admin.Payment.fullpayment_view',$payment->id)}}"><i class="ri-pencil-line mr-0"></i></a>
                                    </div>
                                </td> --}}
                                 </tr>
                                @endforeach
