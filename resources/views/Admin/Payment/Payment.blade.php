            ...
            <div class="row">
                <div class="col-sm-12 col-lg-6">
                    ...
                    <div class="card">
                        ...
                        <button class="btn sidebar-bottom-btn btn-lg bt "
                        class="btn btn-dark mt-2 btn-lg btn-block"
...
<br>
                                    ...
                                    <form action="{{ route('Admin.Store.service_item') }}" method="post"
                                        ...
                                        <tr>
                                            ...
                                            <label hidden for="">Owner name</label>
                                            <input type="hidden" class="form-control" value="*******" name="Owner_name"
                                                id="" required>
                                            <label hidden for="">Phone</label>
                                            <input type="hidden" class="form-control" value="*******" name="Phone"
                                                id="" required>
                                            ...
                                            @foreach ($get_cart as $get_cart)
                                                ...
                                                <input type="hidden" name="qty" value="{{ $get_cart->qty }}"
                                                    id="">
                                                ...
                                                <input type="hidden" name="service" value="{{ $get_cart->service }}"
                                                    id="">
                                                <input type="hidden" name="service" value="{{ $get_cart->qty }}"
                                                    id="">
                                                <input type="hidden" name="Amount" value="{{ $get_cart->Amount }}"
                                                    id="">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('Admin.Store.item') }}"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <h6 class="card-title">Treatment description</h6>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input type="number" placeholder="Enter amount" name="Amount" class="form-control" id="" required>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button class="btn sidebar-bottom-btn btn-lg btn-block">Process</button>
