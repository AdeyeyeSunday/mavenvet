               ...
               <div class="col-sm-12">
                  <div class="card">
                     <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="header-title">
                        <a href="{{ route('Admin.Pos.store_cash') }}">  <h6 style="color: green"  class="card-title"> Cash: ₦:
                         ...
                         <div class="header-title">
                         <a href="{{ route('Admin.Pos.store_transfer') }}"> <h6 style="color: green"  class="card-title"> Transfer: ₦:
                         ...
                         <div class="header-title">
                       <a href="{{ route('Admin.Pos.store_pos') }}"><h6 style="color: green"  class="card-title"> Pos: ₦:
