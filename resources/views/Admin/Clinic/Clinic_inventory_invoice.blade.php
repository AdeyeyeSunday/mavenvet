              ...
              <div class="card card-block card-stretch card-height print rounded">
                 ...
                 <div class="card-body">
                   ...
                   @endif
                       ...
                       <center> <div class="alert alert-primary" role="alert">
                      <div class="iq-alert-text">{{Session::get('Discount')}}  Is {{ $Clinic_inventory_invoice->discount }}  !!!!</div>
                     </div>
                          ...
                          <div class="offset-lg-8 col-lg-4">
                             <div class="or-detail rounded">
                                   <div class="p-3">
                                      ...
                                      <div>
                                        <h6>Discount</h6>
                                        <form action="{{route('Admin.Clinic.vaccin_discount',$Clinic_inventory_invoice->id)}}">
                                            @csrf

                                            @if ($Clinic_inventory_invoice->discount > 1)
                                                <button disabled><h6>{{ $Clinic_inventory_invoice->discount }}</h6></button>
                                          @else
                                            ₦: <input type="text" name="discount" id="" value="{{ $Clinic_inventory_invoice->discount  }}" style="width: 80px;">
                                    ...
                                    {{-- <h6>Grant total </h6>
                                    <h6 >₦{{$Clinic_inventory_invoice->total- $Clinic_inventory_invoice->discount }} </h5> </h6><br> --}}
                                    ...
                                    @else
                                    <h6>Grant total </h6>
                                    <h6 >₦{{$Clinic_inventory_invoice->total- $Clinic_inventory_invoice->discount}} </h6><br>
                                    @endif

                                    <h6>Mode of Payment</h6>
                                    <a href="{{route('Admin.Clinic.order_cash',$Clinic_inventory_invoice->id)}}" class="btn btn-success">Cash</a>
                                    <a href="{{route('Admin.Clinic.order_pos',$Clinic_inventory_invoice->id)}}" class="btn btn-info">Pos</a>
                                    <a href="{{route('Admin.Clinic.order_transfer',$Clinic_inventory_invoice->id)}}" style="margin-right: 15px;" class="btn btn-primary">Transfer</a>
                                    <a href="{{route('Admin.Clinic.cash_pos',$Clinic_inventory_invoice->id)}}" class= "btn btn-danger">Cash/Pos</a>
                                    <a href="{{route('Admin.Clinic.cash_transfer',$Clinic_inventory_invoice->id)}}" class="btn btn-warning" style="margin-right: 26px;">Cash/Transfer</a>
                                    </div>
                                  </div>
                                  ...
                                  <div class="ttl-amt py-2 px-3 d-flex justify-content-between align-items-center">
                                   ...
                                   <input type="number" disabled class="form-control" value="{{ $Clinic_inventory_invoice->pay }}" name="pay" style="width: 120px" placeholder="Pay" >
                                   ...
                                   @else
                                   <label for="">Cash:</label>
                                   <input type="number" class="form-control" value="0" name="pay" style="width: 120px" placeholder="Pay" >
                                   <input type="hidden" class="form-control" value="0" name="cash_pos" >
                                   <input type="hidden" class="form-control" style="width: 120px" value="0" name="cash_transfer">
                                   @endif
                                   @if (($Clinic_inventory_invoice->pay > 1 ))
                                ...
                                <label for="">Pos:</label>
                                   ...
                                   <input type="number" disabled class="form-control" value="{{ $Clinic_inventory_invoice->cash_pos }}"  style="width: 120px" name="cash_pos">
                                   ...
                                   @else
                                   <input type="number" class="form-control" value="0"  style="width: 120px" name="cash_pos">
                                   ...
                                   <input type="number" disabled placeholder="Transfer" class="form-control" style="width: 120px" value="0" name="cash_transfer">
                                   <input type="hidden" class="form-control" value="0"  style="width: 120px" name="cash_pos">
                                   <input type="hidden" class="form-control" value="0" name="pay" style="width: 120px" placeholder="Pay" >
                                   @else

                                   <label for="">Transfer:</label>
                                   <input type="number" placeholder="Transfer" class="form-control" style="width: 120px" value="0" name="cash_transfer">
                                   <input type="hidden" class="form-control" value="0"  style="width: 120px" name="cash_pos">
                                   <input type="hidden" class="form-control" value="0" name="pay" style="width: 120px" placeholder="Pay" >
                                   ...
                                   @if ($Clinic_inventory_invoice->cash_pos > 1)
                                   <label for="">Pos:</label>
                                   <input type="number" disabled class="form-control" style="width: 120px" value="{{ $Clinic_inventory_invoice->cash_pos }}" name="cash_pos">
                                   <input type="hidden" class="form-control" style="width: 120px" value="0" name="cash_transfer">
                                   <label for="">Cash:</label>
                                   <input type="number" disabled placeholder="Transfer" class="form-control" style="width: 120px" value="{{ $Clinic_inventory_invoice->pay }}" name="pay">
                                   @else
                                   <label for="">Pos:</label>
                                   <input type="number" class="form-control" style="width: 120px" value="0" name="cash_pos">
                                   <input type="hidden" class="form-control" style="width: 120px" value="0" name="cash_transfer">
                                   <label for="">Cash:</label>
                                   <input type="number" placeholder="Transfer" class="form-control" style="width: 120px" value="0" name="pay">
                                   @endif
                                    @if (($Clinic_inventory_invoice->cash_pos > 1 ))
                                   <button type="submit" disabled class="btn btn-primary">Paid</button>
                                   @else($Clinic_inventory_invoice->cash_pos > 1 )
                                   ...
                                   <input type="number" disabled placeholder="Transfer" class="form-control" style="width: 120px" value="{{ $Clinic_inventory_invoice->cash_transfer }}" name="cash_transfer">
                                   <label for="">Cash:</label>
                                   <input type="number" disabled placeholder="Transfer" class="form-control" style="width: 120px" value="{{ $Clinic_inventory_invoice->pay }}" name="pay">
                                   @else
                                   <label for="">Transfer:</label>
