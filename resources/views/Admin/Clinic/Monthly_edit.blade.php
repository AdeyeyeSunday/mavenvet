                  ...
                  <div class="col-sm-12 col-lg-6">
                     <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <form method="post" enctype="multipart/form-data" action="{{route('Admin.Clinic.Monthly_update',$Expense->id)}}">
                               @csrf
                               @method('PATCH')
                              <div class="form-group">
                                 <label for="">Name:</label>
                                 <input type="text" readonly value="{{$Expense->name}}" class="form-control" name="name">
                              </div>
                              <div class="form-group">
